                        ...
                        <div className={classNames(styles['profile-container'], styles['hide'])}>
                            ...
                            { showProfile && (
                                <div className={styles['dropdown-menu']}>
                                    ...
                                    <Link to="/profile/trainer">{user.teacher ? ("Eğitmen Paneli") : ("Eğitmen Olun")}</Link>
                                ...
                                <React.Fragment>
                                    ...
                                    <div className={styles["custom-row"]} style={{gap:"8px" ,justifyContent:"start"}}>
                                        ...
                                        <div>
                                            ...
                                            <Link to="/profile/trainer" className={styles['category-text']}>{user.teacher ? ("Eğitmen Paneli") : ("Eğitmen Olun")}</Link>
